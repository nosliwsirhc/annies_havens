...
imageAlt: A family of four walking together and holding hands along a sidewalk.
---
...
The Public Health Agency of Canada describes [trauma- and violence-informed approaches](https://www.canada.ca/en/public-health/services/publications/health-risks-safety/trauma-violence-informed-approaches-policy-practice.html) as policies and practices that recognize the connections between violence, trauma, negative health outcomes, and behaviours. These approaches are meant to increase safety, control, and resilience for people who may have experienced violence or trauma.

The same resource identifies four broad principles:

:::keypoints{title="Four principles of trauma- and violence-informed care"}
...
Ontario has also built trauma-informed care into foster-care training expectations. The Government of Ontario's [Policy Directive: Residential Licensing 001-23](https://www.ontario.ca/document/child-protection-service-directives-forms-and-guidelines/policy-directive-residential-licensing-001-23-training-provision-foster-care) requires foster parents to complete training on providing trauma-informed care. The directive says the training must help foster parents shift the focus from "What's wrong with you?" to "What happened to you?" and must include understanding the impact of trauma, recognizing signs and symptoms of trauma in children and youth, and learning how to actively resist re-traumatization.
...
:::callout{title="Before correcting, adults can pause"}
When a child is overwhelmed, a few questions can guide the response:

- Is the child physically safe right now?
- Is anyone else unsafe?
- Is the child hungry, tired, sick, in pain, overstimulated, or frightened?
- Is the expectation clear and realistic for this child today?
- Can I lower my voice, slow down, and reduce the number of demands?
- Can I offer a small choice so the child has some control?
- Can I reconnect before I correct?
:::
...
::figure{src="/images/about-slider-image-2" alt="A caregiver holding a small child, the two looking at each other against a cloudy mountain sky." caption="Safety is built in ordinary moments: a calm voice, a small choice, a chance to try again." width="1920" height="620" widths="640,1024,1440" formats="avif,webp"}
...
The Ontario Association of Children's Aid Societies' [Trauma Informed Care: Supporting Children and Youth](https://www.oacas.org/programs-and-resources/learning-and-training/trauma-informed-care/) course includes topics such as the impact of trauma on the developing brain, trauma and attachment, the threat response system, the window of tolerance, responding to big emotions and behaviours, communication with children and youth, caregiver self-care, and supporting youth with behaviours that may put themselves or others at risk.
...
Could your home be a safe, steady place for a child who needs one? It takes about two minutes to find out.
:::
...
This is especially important for children living with intellectual or developmental disabilities. Surrey Place's [Developmental Disabilities Primary Care Program](https://ddprimarycare.surreyplace.ca/tools-2/mental-health/trauma-informed-health-care/) notes that people with intellectual and developmental disabilities are at greater risk of adverse life events and are more likely to experience trauma than people in the general population. It also notes that people with intellectual and developmental disabilities may not be able to verbalize distress, and that distress may instead present as behaviours that are concerning or difficult to manage.

For Autistic children, communication and sensory needs also matter. The Government of Canada's [autism supports and services](https://www.canada.ca/en/public-health/services/diseases/autism-spectrum-disorder-asd/supports-services.html) page explains that some Autistic people communicate verbally or non-verbally and may benefit from supports such as speech and language therapy, occupational therapy, caregiver training, behavioural therapy, and school planning. The same resource describes caregiver training as including effective communication, support in triggering situations, and supportive routines and behaviours that bring comfort and promote success.
...
The Public Health Agency of Canada includes [choice, collaboration, and connection](https://www.canada.ca/en/public-health/services/publications/health-risks-safety/trauma-violence-informed-approaches-policy-practice.html) as core parts of trauma- and violence-informed approaches. The Canadian Paediatric Society's 2026 [trauma-informed care in paediatrics](https://cps.ca/en/tools-outils/trauma-informed-care-in-paediatrics) resource also emphasizes safe care from trusted providers and highlights youth perspectives on care that feels safe, respectful, private, and centred on the young person's concerns.
...
The Public Health Agency of Canada notes that organizations can help reduce secondary trauma for service providers through policies and practices that actively support well-being and self-care. OACAS' [Trauma Informed Care](https://www.oacas.org/programs-and-resources/learning-and-training/trauma-informed-care/) course also includes caregiver self-care and encourages caregivers to develop a self-care plan for their own health and emotional well-being.
...
To learn more about Annie's Havens' approach, you can read about [our care programs](/care-programs), [children in care](/children-in-care), and [foster care in Ontario](/foster-care-in-ontario).
...
- [Public Health Agency of Canada: Trauma and violence-informed approaches to policy and practice](https://www.canada.ca/en/public-health/services/publications/health-risks-safety/trauma-violence-informed-approaches-policy-practice.html)
- [Government of Ontario: Policy Directive, Residential Licensing 001-23: Training on the Provision of Foster Care](https://www.ontario.ca/document/child-protection-service-directives-forms-and-guidelines/policy-directive-residential-licensing-001-23-training-provision-foster-care)
- [Ontario Association of Children's Aid Societies: Trauma Informed Care, Supporting Children and Youth](https://www.oacas.org/programs-and-resources/learning-and-training/trauma-informed-care/)
- [Canadian Paediatric Society: Trauma-informed care in paediatrics](https://cps.ca/en/tools-outils/trauma-informed-care-in-paediatrics)
- [Canadian Paediatric Society: From ACEs to early relational health](https://cps.ca/en/documents/position/from-aces-to-early-relational-health)
- [Harvard University Center on the Developing Child: Toxic Stress](https://developingchild.harvard.edu/key-concept/toxic-stress/)
- [Surrey Place Developmental Disabilities Primary Care Program: Trauma-Informed Health Care](https://ddprimarycare.surreyplace.ca/tools-2/mental-health/trauma-informed-health-care/)
- [Government of Canada: Autism supports and services](https://www.canada.ca/en/public-health/services/diseases/autism-spectrum-disorder-asd/supports-services.html)
