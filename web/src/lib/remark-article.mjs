/**
 * Annie's Havens article directives.
 *
...
// A link is "external" if it points off annieshavens.ca. Relative links,
...
function isExternalLink(url) {
  ...
  try {
    return new URL(url).hostname.replace(/^www\./, '') !== 'annieshavens.ca';
  } catch {
    return false;
  }
}
